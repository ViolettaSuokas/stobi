...
export function translateScanError(
  ...
  if (kind === 'find-anywhere') {
    return {
      title: 'Камня нет в нашей базе',
      message: 'К сожалению, такого камня в Stobi пока нет. Возможно, кто-то его раскрасил сам и не знает про наше приложение.',
      tips: [
        'Если уверен что камень из Stobi — попробуй ещё ракурс или ближе',
